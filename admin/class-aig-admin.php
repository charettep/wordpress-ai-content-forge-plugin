...
SVG;
    ...
    public static function register_menu(): void {
        add_menu_page(
            ...
            'manage_options',
            'ai-genie',
            [ self::class, 'render_providers_page' ],
            self::menu_icon_data_uri(),
            66
        );

        // Rename the auto-generated first submenu entry from "AI Genie" to "AI Providers".
        add_submenu_page(
            'ai-genie',
            __( 'AI Providers — AI Genie', 'ai-genie' ),
            __( 'AI Providers', 'ai-genie' ),
            'manage_options',
            'ai-genie',
            [ self::class, 'render_providers_page' ]
        );
    ...
    public static function enqueue_assets( string $hook ): void {
        $our_hooks = [
            'toplevel_page_ai-genie',
            'ai-genie_page_ai-genie-prompts',
            'ai-genie_page_ai-genie-help',
        ];
    ...
    private static function get_prompts_config(): array {
        return [
            'post_content' => [
    ...
    private static function get_placeholders(): array {
        return [
            '{title}', '{tone}', '{keywords}', '{keywords_line}',
            '{post_type}', '{language}', '{structure}', '{structure_line}',
            '{target_length}', '{target_length_line}', '{existing_content}',
            '{existing_content_block}',
        ];
    }

    private static function render_page_header( string $title ): void {
        ?>
    ...
    private static function render_save_footer(): void {
        ?>
    ...
    public static function render_providers_page(): void {
        ...
        self::render_page_header( __( 'AI Providers', 'ai-genie' ) );
        ?>
        <form method="post" action="options.php" id="aig-settings-form">
            <?php settings_fields( 'aig_settings_group' ); ?>
            <input type="hidden" name="<?php echo esc_attr( $opt ); ?>[_aig_form_section]" value="providers">
            ...
            <!-- Claude -->
            <details class="aig-card aig-provider-section aig-provider-collapsible" id="section-claude">
                <summary class="aig-provider-header aig-provider-summary">
                    ...
                    <span class="aig-provider-chevron" aria-hidden="true"></span>
                </summary>
                <div class="aig-provider-body">
            ...
            <!-- OpenAI -->
            <details class="aig-card aig-provider-section aig-provider-collapsible" id="section-openai">
                <summary class="aig-provider-header aig-provider-summary">
            ...
            <!-- Ollama -->
            <?php $ollama_has_auth = ! empty( $settings['ollama_auth_header_name'] ) || ! empty( $settings['ollama_auth_header_value'] ); ?>
            <details class="aig-card aig-provider-section aig-provider-collapsible" id="section-ollama">
                <summary class="aig-provider-header aig-provider-summary">
                ...
                <div class="aig-provider-body">
                    ...
                    <p class="aig-provider-footer-link">
                        ...
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=ai-genie-help' ) ); ?>"><?php esc_html_e( 'Open Setup Guide →', 'ai-genie' ); ?></a>
                    </p>
                </div>
            </details>

            <?php self::render_save_footer(); ?>
    ...
    public static function render_prompts_page(): void {
        ...
        self::render_page_header( __( 'Prompts', 'ai-genie' ) );
        ?>
        <form method="post" action="options.php" id="aig-settings-form">
            <?php settings_fields( 'aig_settings_group' ); ?>
            <input type="hidden" name="<?php echo esc_attr( $opt ); ?>[_aig_form_section]" value="prompts">
                ...
                <div class="aig-prompt-layout">
                    ...
                    <nav class="aig-prompt-rail" aria-label="<?php esc_attr_e( 'Prompt types', 'ai-genie' ); ?>">
                        ...
                        <?php foreach ( $prompts as $type => $config ) : ?>
                            <button type="button"
                                    class="aig-prompt-rail-item <?php echo $first ? 'is-active' : ''; ?>"
                                    data-prompt-type="<?php echo esc_attr( $type ); ?>">
                                <span class="aig-prompt-rail-icon"><?php echo $config['icon'] ?? '📄'; ?></span>
                    ...
                    <div class="aig-prompt-editor">
                        ...
                        <?php foreach ( $prompts as $type => $config ) :
                            ...
                            <div class="aig-prompt-pane <?php echo $first ? 'is-active' : ''; ?>"
    ...
    public static function render_help_page(): void {
        ...
        self::render_page_header( __( 'Help', 'ai-genie' ) );
        ?>
